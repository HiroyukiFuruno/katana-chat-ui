...
#[derive(Clone)]
pub struct FloemComposerActions<
    OnAttach,
    OnRemoveAttachment,
    OnSubmit,
    OnStop,
...
> {
    ...
    pub(super) on_vendor_select: OnVendorSelect,
    pub(super) on_control_select: OnControlSelect,
}

impl<OnAttach, OnRemoveAttachment, OnSubmit, OnStop, OnVendorSelect, OnControlSelect>
    FloemComposerActions<
        OnAttach,
        OnRemoveAttachment,
        OnSubmit,
        OnStop,
