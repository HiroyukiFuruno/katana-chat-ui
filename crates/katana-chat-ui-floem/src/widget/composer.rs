...
use floem::{peniko::Color, prelude::*, views::Stack};
use katana_chat_ui::{ChatUiComposerSurface, ChatUiSurface, ChatUiVendorBarSurface};
...
fn composer_body<OnAttach, OnRemoveAttachment, OnSubmit, OnStop, OnVendorSelect, OnControlSelect>(
    surface: RwSignal<ChatUiSurface>,
    draft: RwSignal<String>,
    actions: FloemComposerActions<
        OnAttach,
...
fn controls<OnAttach, OnRemoveAttachment, OnSubmit, OnStop, OnVendorSelect, OnControlSelect>(
    surface: RwSignal<ChatUiSurface>,
    draft: RwSignal<String>,
    actions: FloemComposerActions<
        OnAttach,
