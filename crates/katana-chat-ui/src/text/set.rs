...
pub struct ChatTextSet {
    ...
    pub generating_status: String,
    pub editing_status: String,
    pub reading_status: String,
    pub searching_status: String,
    pub web_searching_status: String,
    pub executing_status: String,
...
impl ChatTextSet {
    pub fn from_catalog(catalog: &TextCatalog) -> Self {
        Self {
            ...
            processing_status: catalog.resolve(ChatTextKey::ProcessingStatus),
            generating_status: catalog.resolve(ChatTextKey::GeneratingStatus),
            editing_status: catalog.resolve(ChatTextKey::EditingStatus),
            reading_status: catalog.resolve(ChatTextKey::ReadingStatus),
            searching_status: catalog.resolve(ChatTextKey::SearchingStatus),
            web_searching_status: catalog.resolve(ChatTextKey::WebSearchingStatus),
            executing_status: catalog.resolve(ChatTextKey::ExecutingStatus),
